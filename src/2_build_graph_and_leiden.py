# -*- coding: utf-8 -*-
"""
步骤2（时序版）：构建风险传播图 + 团伙发掘 + 无标签中介识别
功能：
  - **仅使用 train_transactions.csv（2024年及之前）构图**
  - 保留所有原始团伙发掘、中介识别逻辑
  - 保留所有 print() 日志
"""
import os
...
print("=== 步骤2（时序版）：构建风险传播图 + 团伙发掘 + 无标签中介识别 ===")
start_time_total = time.time()

# ==================== 1. 定义路径和参数 ====================
# INPUT_TXN_PATH = 'D:/Pycharm/Intermediaries_digging/data/cleaned_transactions.csv'  #
INPUT_TXN_PATH = 'D:/Pycharm/Intermediaries_digging/data/train_transactions.csv'      #
...
print(f"\n 步骤2（时序版）完成！总运行时间: {time.time() - start_time_total:.2f} 秒")